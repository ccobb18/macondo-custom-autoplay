...
const file_api_proto_macondo_macondo_proto_rawDesc = "" +
	"\n" +
	"\x1fapi/proto/macondo/macondo.proto\x12\amacondo\"\xba\x05\n" +
	"\vGameHistory\x12*\n" +
...
var (
	...
	file_api_proto_macondo_macondo_proto_rawDescData []byte
)

func file_api_proto_macondo_macondo_proto_rawDescGZIP() []byte {
	file_api_proto_macondo_macondo_proto_rawDescOnce.Do(func() {
		file_api_proto_macondo_macondo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_proto_macondo_macondo_proto_rawDesc), len(file_api_proto_macondo_macondo_proto_rawDesc)))
	})
